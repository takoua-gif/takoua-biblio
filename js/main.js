...
$(document).ready(function() {
    ...
    // PRELOADER FALLBACK: Force-hide preloader after a maximum of 2.5 seconds to prevent visual lockups
    setTimeout(function() {
        if (!$('body').hasClass('loaded')) {
            $('body').addClass('loaded');
            console.log("Preloader dismissed by fallback timeout.");
        }
    }, 2500);
    ...
    // Banner Height - Disabled for custom flexbox implementation
    /*
    ...
    */
    ...
    $(window).scroll(function(){
        ...
        if($window.scrollTop() >= win_height ) {
            ...
            // logo image swap removed for text brand
        } else {
